...
aiMove me gs@GameState {phase = (WaitingForCard p), players = players, trump=trump, currentColor=currentColor, stdGen=gen} = cardToPlay gs me players trump currentColor gen
...
cardToPlay gs PlayerState{hand=hand, player=me} trump currentColor gen = PlayCard (playerName me) (randomCard (playeableCards (playerName me) gs) gen)
